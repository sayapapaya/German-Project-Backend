...
public class Gear extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   *   {@code Gear.Greetings.List request = gear.greetings().list(parameters ...)}
   * </pre>
   *
  ...
  public class Greetings {
    ...
    public class GetGreeting extends GearRequest<com.appspot.backendgear_1121.gear.model.GearBackendGreeting> {
      ...
      protected GetGreeting(java.lang.Integer id) {
        super(Gear.this, "GET", REST_PATH, null, com.appspot.backendgear_1121.gear.model.GearBackendGreeting.class);
    ...
    public class ListGreeting extends GearRequest<com.appspot.backendgear_1121.gear.model.GearBackendGreetingCollection> {
      ...
      protected ListGreeting() {
        super(Gear.this, "GET", REST_PATH, null, com.appspot.backendgear_1121.gear.model.GearBackendGreetingCollection.class);
      }
     ...
     * @return the request
     */
    public Multiply multiply(java.lang.Integer times, com.appspot.backendgear_1121.gear.model.GearBackendGreeting content) throws java.io.IOException {
      Multiply result = new Multiply(times, content);
      initialize(result);
      return result;
    }

    public class Multiply extends GearRequest<com.appspot.backendgear_1121.gear.model.GearBackendGreeting> {
       ...
       * @since 1.13
       */
      protected Multiply(java.lang.Integer times, com.appspot.backendgear_1121.gear.model.GearBackendGreeting content) {
        super(Gear.this, "POST", REST_PATH, content, com.appspot.backendgear_1121.gear.model.GearBackendGreeting.class);
